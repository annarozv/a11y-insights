  ...
  return (
    <>
      ...
      <section className="Main-fragment">
        ...
        <p>“Piekļūstamības atziņas” ir <span className="Main-bold">atklāts piekļūstams informatīvs tīmekļa resurss</span>, kura mērķis ir vienkāršiem vārdiem paskaidrot, kas ir piekļūstamība tīmeklī, kāpēc tā ir svarīga un kādā veidā to ir iespējams nodrošināt. Resurss īpaši paredzēts <span className="Main-bold">tīmekļa vietņu veidotājiem</span> – programmētājiem, satura veidotājiem, dizaineriem un testētājiem.</p>
