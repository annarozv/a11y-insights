    ...
    <>
      ...
      <section className="Main-fragment">
        ...
        <ul className="Main-list">
          <li>Vietnes kods ir rakstīts <span className="Main-bold">atbilstoši specifikācijām</span> (HTML valodas specifikācijai, ARIA specifikācijai utt.) un atbilstoši labākajām praksēm.</li>
      ...
      <section className="Main-fragment">
        ...
        <section className="Main-fragment__nested">
          <h3>ARIA Stāvokļi</h3>
          <p>Ar ARIA stāvokļiem (<span lang="en">state</span>) var <span className="Main-bold">precizēt elementa pašreizējo stāvokļi</span>.</p>
        ...
        <section className="Main-fragment">
          <h3>Izmantošana</h3>
          <p><span className="Main-bold">Svarīgi:</span> vienmēr ir jādod <span className="Main-bold">priekšrocība iebūvētiem semantiskajiem HTML elementiem</span> – ARIA atribūti ir jāizmanto tikai tad, kad ar natīvo HTML nepietiek.</p>
      ...
      <section className="Main-fragment">
        ...
        <p>Ir jānodrošina <span className="Main-bold">satura pārkārtojums un teksta aplaušana</span> (angliski <span lang="en"><i>wrapping</i></span>), lai lietotājs nebūtu piespiest ritināt lapu vertikāli un horizontāli, lai uztvertu saturu.</p>
      ...
      <section className="Main-fragment">
        ...
        <section className="Main-fragment__nested">
          ...
          <p>Šie vienkārši noteikumi palīdzes nodrošināt mijiedarbības piekļūstamību:</p>
          <ul className="Main-list">
        ...
        <section className="Main-fragment__nested">
          <h3>Fokusa secība</h3>
          <p>Ļoti svarīgs tastatūras piekļūstamības aspekts ir <span className="Main-bold">loģiska un skaidra fokusa secība</span>, kas atbilst satura vizuālai reprezentācijai. Ļoti bieži tas ir no augšas uz leju un no kreisās puses uz labo pusi.</p>
          <p>Pēc noklusējuma visi <span className="Main-bold">interaktīvie elementi ir fokusējami</span>: <code>&lt;button&gt;</code>, <code>&lt;a&gt;</code>, <code>&lt;input&gt;</code> utt. Bet ir situācijas, kad ir nepieciešams to pielāgot. </p>
          ...
          <p>Šo ir jāizmanto <span className="Main-bold">piesardzīgi</span>, jo fokusējamiem ir jābūt tikai tieši interaktīviem elementiem.</p>
          ...
          <p><span className="Main-bold">Svarīgi:</span> vērtības "1" un augstāk <code>tabindex</code> atribūtam <span className="Main-bold">nav ieteicams</span> izmantot, jo tās var izjaukt paredzēto fokusa secību un radīt piekļūstamības barjeras.</p>
        </section>
        <section className="Main-fragment">
      ...
      <section className="Main-fragment">
        ...
        <p>Piemērs, ka lietotāju informēšanai var izmantot teksta fragmentu ar ARIA lomu <code>status</code>:</p>
        <pre className="Code-snippet" aria-label="Koda bloks">
          <code>
