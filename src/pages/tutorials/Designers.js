...
function Designers() {
  useEffect(() => {
    document.title = 'Piekļūstamības nodrošināšanas ieteikumi dizaineriem | Piekļūstamības atziņas';
  }, []);
  ...
  return (
    <>
      <h1>Piekļūstamības nodrošināšanas ieteikumi dizaineriem</h1>
      <section className="Main-fragment">
        <h2>Galvenie aspekti</h2>
        <p>Izstrādājot dizainu tīmekļa vietnei, dizaineriem ir jārūpējas par satura <span className="Main-bold">uztveramību</span> un <span className="Main-bold">saprotamību</span>. </p>
      ...
      <section className="Main-fragment">
        ...
        <section className="Main-fragment Main-fragment__nested">
          ...
          <p><span className="Main-bold">Svarīgi: baltā krāsa ar melno krāsu veido pārāk augstu kontrastu</span>, kas var radīt neērtības cilvēkiem ar redzes traucējumiem. Lai no tā izvairītos, ir ieteicams baltās krāsas vietā izvēlēties pelēkbalto vai citu neitrālu gaišu krāsu un melnās krāsas vietā – tumši pelēko.</p>
          ...
          <p><Link className='Main-link' to='https://coolors.co/' target='_blank'>Coolors</Link> arī piedāvā rīku, kas ļauj uzģenerēt piekļūstamas krāsu kombinācijas, kuras var tālāk izmantot tīmekļa vietnes dizainā.</p>
        </section>
        <section className="Main-fragment">
          <h3>Krāsu nozīme</h3>
          ...
          <ul className="Designers-colors">
            <li><span className="Designers-colors-square Designers-green" aria-label="Zaļās krāsas kvadrātiņš"></span>Zaļa</li>
            <li><span className="Designers-colors-square Designers-white" aria-label="Baltās krāsas kvadrātiņš"></span>Balta</li>
            <li><span className="Designers-colors-square Designers-red" aria-label="Terakotās krāsas kvadrātiņš"></span>Terakota</li>
          </ul>
        </section>
      </section>
      <section className="Main-fragment">
        ...
        <section className="Main-fragment Main-fragment__nested">
          <h3>Burtu izmērs</h3>
          <p>Ir ieteikts izmantot burtu izmēru, kas būtu <span className="Main-bold">ne mazāks par 12pt</span>, jo mazāks izmērs var apgrūtināt lasīšanu vai pat padarīt to par neiespējamu. Piemērs: </p>
          <p className="Main-example Main-example-block Designers-smalltext">Pārāk mazs burtu izmērs var lietotājiem radīt saspridzinājumu un pat atturēt viņus no teksta lasīšanas. Lietotājiem ar redzes traucējumiem mazs burtu izmērs var kļūt par nepārvaramu barjeru satura uztverei.</p>
        ...
        <section className="Main-fragment Main-fragment__nested">
          <h3>Izlīdzinājums</h3>
          <p>Teksta rindkopu <span className="Main-bold">izlīdzināšana centrā nav ieteicama</span>, jo šādi izlīdzinātajā tekstā ir grūtāk atrast katras jaunas rindas sākumu:</p>
          <p className="Main-example Main-example-block Main-center">Senos laikos kaķis ar peli dzīvojuši kopā kā vīrs ar sievu vienā mājā. Kaķis gājis uz lauku medīt, un pelīte taisījusi ēdienu, cepusi gaļu un vārījusi putru. Pelīte bijusi laba un taupīga saimniece, un kaķis bijis ar viņu ļoti mierā. Reiz viņi abi kopā norunājuši iekrāt kaut ko arī bada dienām. Bet ko nu krāt? Pelīte sadomājusi, ka vislabāki būtu taukus krāt. Labi! Nu pelīte sākusi pa drusciņai vien lasīt taukus un krāt podiņā. Pēdīgi viņa piekrājusi pilnu podiņu, apsējusi ar platu kļavas lapu, un abi ar kaķīti aiznesuši uz mežu un paglabājuši biezos krūmos. <br/>(Avots: <Link to='https://pasakas.eu/kakis-un-pele-3' target='_blank'><u>Kaķis un pele</u></Link>)</p>
          <p>Teksta <span className="Main-bold">izlīdzināšana gar abām malām arī nav ieteicama</span>, jo tekstā var veidoties nekonsekventas atstarpes starp vārdiem un tā saucamās "tukšūma upes" (angliski <span lang="en"><i>rivers of white</i></span>) – atstarpes, kas iet caur vairākām rindām un pasliktina lasāmību:</p>
          <p className="Main-example Main-example-block Main-justify">Kaķis apprecēja žurku un abi sadzīvoja dažus gadus itin laimīgi. Te vienu reizi kaķim iegribējās tauku. Un žurkai jau no senākām dienām bija iekrājušies tauki, brangi podi; tādēļ kaķis iesāka gudrot, kā šos tauku podus rokā dabūt. Gudroja, gudroja – aizgāja pie žurkas tēva un iztriecās ilgi jo ilgi. Bet pārnācis mājā, nu iemelsa žurkai, ka viņas māte mirstot nost. Žurka, zināms, tūliņ prom māti raudzīt, vai taisnība, ko kaķis tur sateicis. Bet kāmēr žurka pie vecākiem, kaķis ēd taukus ārā. Patlaban jau rija beidzamo podu, te pārnāks žurka, ierauga: šis pie tauku podiem! Un nu sāk lieliski lamāties. Kaķis saka, lai viņu tā nelamājot. Bet kas tev klausīs? <br/>(Avots: <Link to='https://pasakas.eu/kakis-un-pele-2' target='_blank'><u>Kaķis un žurka</u></Link>)</p>
          ...
          <p className="Main-example Main-example-block">Reiz rijas sermuliņš noķēra žurku un, zināms, apēda bez sāls, bez itin nekā. Bet kaķis pa to starpu arī bij tīkojis žurku tiesāt; tomēr kad nu sermuliņš bij aizsteidzies priekšā, tad viņš domāja citādi darīt: viņš ķeršot sermuliņu un, sermuliņu ēzdams, apēdīšot ir to žurku līdz. Un tā klupis sermuliņam čuprā. Bet nu mums būtu jāiet skatīties, vai noēdīs abus uz reizi, vai nenoēdīs? <br/>(Avots: <Link to='https://pasakas.eu/kakis-zurka-un-sermulins' target='_blank'><u>Kaķis, žurka un sermuliņš</u></Link>)</p>
        </section>
        <section className="Main-fragment">
          <h3>Teksta struktūra un dekorācija</h3>
          <p><span className="Main-bold">Ātrās atziņas</span> par teksta noformēšanu:</p>
          <ul className="Main-list">
            ...
            <li>Pārāk <span className="Main-bold"><span className="Main-uppercase"><i>daudz</i> dažādu</span> dekorāciju</span> <span className="Main-strike">pasliktina</span> <span className="Main-uppercase">lasāmību</span></li>
            <li>Dekorācijas ir jāizmanto konsekventi un nedublējot vispārpieņemto nozīmi – <u>šīs teksts pasvītrojuma dēļ var tikt uztverts kā saite</u></li>
          </ul>
        </section>
      </section>
      <section className="Main-fragment">
        <h2>Kopējā satura struktūra</h2>
        <p>Lai veicinātu satura uztveramību, ir jādefinē <span className="Main-bold">skaidras attiecības starp satura komponentiem</span>. To var panākt, pielietojot grupēšanas principus:</p>
        ...
        <p>Vizuāli izkliedēti ievadlauki ar vienādām atstarpēm (attēlā pa kreisi) var samulsināt lietotāju un palielināt laiku, kas būs patērēts veidlapas aizpildīšanai, un, iespējams, palielināt arī kļūdu skaitu. Bet, ja mēs <span className="Main-bold">vizuāli sagrupēsim</span> katru ievadlauku un iezīmi, saskarne būs saprotamāka un lietotājam draudzīgāka (attēlā pa labi).</p>
        <p>Arī šī pamācība kopumā var kalpot par piemēru – <span className="Main-bold">pamācības saturs ir sadalīts vairākās sekcijās</span>, kas ir savstarpēji vizuāli atdalītas – katrai sekcijai ir galvenais virsraksts, un sekcijām ir arī apakšsekcijas ar saviem virsrakstiem, kā arī starp tām ir ievērotas atstarpes, kas dod skaidru priekšstatu par to, kur sākas un beidzas katra sekcija.</p>
      </section>      
      <section className="Main-fragment">
        <h2>Pielāgojamība</h2>
        <p>Tīmekļa vietnes saturam ir jābūt piekļūstamam no dažādām ierīcēm, tāpēc dizaina izstrādes posmā ir jāizveido satura izkārtojuma versijas <span className="Main-bold">dažādiem ekrānu izmēriem</span>, vismaz datora darbvirsmai un viedtālrunim.</p>
      </section> 
      <section className="Main-fragment">
        ...
        <section className="Main-fragment">
          ...
          <p>Kā, piemēram, šajā pogas vizualizācijā – novietojot peles kursoru uz tās (vai arī pogai nonākot fokusā), notiek krāsas maiņa:</p>
          <Link 
          ...
          <p>Veidlapu gadījumā, ja ir notikusi validācijas kļūda, ievadlaukiem bieži tiek pievienota sarkana apmale. Protams, ir <span className="Main-bold">jāsniedz arī tekstuālā informācija</span> par kļūdu un tās būtību:</p>
          <div className="Main-example Designers-input">
            <input tabIndex={-1} aria-label="Ilustratīvs ievadlauks"></input>
